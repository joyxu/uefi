...
0I9NvvvCy2kxEv3OwDMDZk8+fpxyF2rb0V7n77g/E/6APFegg9oGWZ9/sMv4dUi/GDqVWHea
dTEqNyuNQiejE8jJhTHdDZ36gK5ezqCvRi7rZZr6c9cdQaH/sxDNlMdqL9jP5w==#*/
  ...
  )
{
  ...
  if (((EfiPciAddress->Bus == PrivateData->BusBase) && (EfiPciAddress->Device == 0x00) && (EfiPciAddress->Function == 0))){
    Address = PrivateData->RbPciBar + Offset;
    //DTS2015081202801 圈复杂度整改
    // 这行目前是规避措施，后续会和海思确认(Offset == 0x10)
