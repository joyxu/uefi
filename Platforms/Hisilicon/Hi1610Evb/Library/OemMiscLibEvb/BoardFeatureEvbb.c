...
EFI_STRING_ID gDimmToDevLocator[MAX_SOCKET][MAX_CHANNEL][MAX_DIMM] = {
  {{STRING_TOKEN(STR_PV660_EVBB_DIMM_000), STRING_TOKEN(STR_PV660_EVBB_DIMM_001), STRING_TOKEN(STR_PV660_EVBB_DIMM_002)},
   {STRING_TOKEN(STR_PV660_EVBB_DIMM_010), STRING_TOKEN(STR_PV660_EVBB_DIMM_011), STRING_TOKEN(STR_PV660_EVBB_DIMM_012)}}
};
